    ...
    <div class="container">
        ...
        if(isset($_POST["submit"])){
            ...
            if(strlen($password)<8){
                array_push($errors,"Password must be atleast 8 charecture long");
            }
            if(strlen($password!==$repeat_password)){
                array_push($errors,"Password does not watch");
            }
            ...
            if(count($errors)>0){
                ...
                //we will insert the data in to database
